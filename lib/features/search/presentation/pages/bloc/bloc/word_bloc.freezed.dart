...
mixin _$WordState {
  ...
  List<Definitions>? get pronounList => throw _privateConstructorUsedError;
  List<Definitions>? get articlesList => throw _privateConstructorUsedError;
  List<Definitions>? get interjectionList => throw _privateConstructorUsedError;
  List<Definitions>? get adverbList => throw _privateConstructorUsedError;
  List<Definitions>? get prepositionList => throw _privateConstructorUsedError;
...
class _$WordStateCopyWithImpl<$Res, $Val extends WordState>
  ...
  $Res call({
    ...
    Object? pronounList = freezed,
    Object? articlesList = freezed,
    Object? interjectionList = freezed,
    Object? adverbList = freezed,
    Object? prepositionList = freezed,
    ...
    return _then(_value.copyWith(
      ...
      adjectiveList: freezed == adjectiveList
          ...
          : adjectiveList // ignore: cast_nullable_to_non_nullable
              as List<Definitions>?,
      pronounList: freezed == pronounList
          ? _value.pronounList
          : pronounList // ignore: cast_nullable_to_non_nullable
              as List<Definitions>?,
      articlesList: freezed == articlesList
          ? _value.articlesList
          : articlesList // ignore: cast_nullable_to_non_nullable
              as List<Definitions>?,
      interjectionList: freezed == interjectionList
          ? _value.interjectionList
          : interjectionList // ignore: cast_nullable_to_non_nullable
              as List<Definitions>?,
      adverbList: freezed == adverbList
          ? _value.adverbList
          : adverbList // ignore: cast_nullable_to_non_nullable
              as List<Definitions>?,
      prepositionList: freezed == prepositionList
          ? _value.prepositionList
          : prepositionList // ignore: cast_nullable_to_non_nullable
              as List<Definitions>?,
...
class _$_WordState implements _WordState {
  const _$_WordState(
      ...
      final List<Definitions>? pronounList,
      final List<Definitions>? articlesList,
      final List<Definitions>? interjectionList,
      final List<Definitions>? adverbList,
      final List<Definitions>? prepositionList,
      this.autoWords})
      : _nounList = nounList,
        _verbList = verbList,
        _adjectiveList = adjectiveList,
        _pronounList = pronounList,
        _articlesList = articlesList,
        _interjectionList = interjectionList,
        _adverbList = adverbList,
        _prepositionList = prepositionList;
  ...
  final List<Definitions>? _pronounList;
  @override
  List<Definitions>? get pronounList {
    final value = _pronounList;
    if (value == null) return null;
    if (_pronounList is EqualUnmodifiableListView) return _pronounList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<Definitions>? _articlesList;
  @override
  List<Definitions>? get articlesList {
    final value = _articlesList;
    if (value == null) return null;
  ...
  final List<Definitions>? _interjectionList;
  @override
  List<Definitions>? get interjectionList {
    final value = _interjectionList;
    if (value == null) return null;
    if (_interjectionList is EqualUnmodifiableListView)
      return _interjectionList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<Definitions>? _adverbList;
  @override
  List<Definitions>? get adverbList {
    final value = _adverbList;
    if (value == null) return null;
    if (_adverbList is EqualUnmodifiableListView) return _adverbList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<Definitions>? _prepositionList;
  @override
  List<Definitions>? get prepositionList {
    final value = _prepositionList;
    if (value == null) return null;
    if (_prepositionList is EqualUnmodifiableListView) return _prepositionList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  @override
  String toString() {
    return 'WordState(status: $status, remoteWordModel: $remoteWordModel, nounList: $nounList, verbList: $verbList, adjectiveList: $adjectiveList, pronounList: $pronounList, articlesList: $articlesList, interjectionList: $interjectionList, adverbList: $adverbList, prepositionList: $prepositionList, autoWords: $autoWords)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._pronounList, _pronounList) &&
            const DeepCollectionEquality()
                .equals(other._articlesList, _articlesList) &&
            const DeepCollectionEquality()
                .equals(other._interjectionList, _interjectionList) &&
            const DeepCollectionEquality()
                .equals(other._adverbList, _adverbList) &&
            const DeepCollectionEquality()
                .equals(other._prepositionList, _prepositionList) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_pronounList),
      const DeepCollectionEquality().hash(_articlesList),
      const DeepCollectionEquality().hash(_interjectionList),
      const DeepCollectionEquality().hash(_adverbList),
      const DeepCollectionEquality().hash(_prepositionList),
      autoWords);
